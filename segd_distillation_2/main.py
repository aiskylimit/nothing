...
KD_LOSS_METRIC_KEYS: Dict[str, Tuple[str, ...]] = {
    ...
    "segd_loss": (
        ...
        "segd_k_eigen_2",
        "segd_k_eigen_3",
        "segd_layer_teacher_0",
        "segd_layer_teacher_1",
        "segd_layer_teacher_2",
        "segd_layer_teacher_3",
        "segd_layer_student_0",
        "segd_layer_student_1",
        "segd_layer_student_2",
        "segd_layer_student_3",
    ),
    "span_propose": (
        "loss",
        "contrastive_loss",
