...
MODEL="training/FastVLM-0.5B_lasd_5layer=resim_1.0_eos_constant_0.05scheduler_cls/checkpoint-epoch-0"
python eval_mmeb.py \
    --model_name $MODEL \
    --encode_output_path "./MMEB-eval_outputs/FastVLM-0.5B_lasd_5layer=resim_1.0_eos_constant_0.05scheduler_cls/" \
