...
def flex_octopus_attention(
    ...
    # cannot use any fused version of attention, since they do not materialize the full attention matrix
    # use 'eager' implementation to modify (redistribute) attention scores
    attention_output: torch.Tensor = torch.tensor([]) # dummy
