...
class OctopusQwen3Config(Qwen3Config):
    model_type = "octopus_qwen3"
    ...
    def __init__(self, **kwargs):
        ...
        # sink token value threshold to identify sink tokens
        self.sink_token_value_threshold = kwargs.get("sink_token_value_threshold", 10)
        
        # separate portion score layers of sink and non-sink tokens
        self.separate_portion_score_layers = kwargs.get("separate_portion_score_layers", False)