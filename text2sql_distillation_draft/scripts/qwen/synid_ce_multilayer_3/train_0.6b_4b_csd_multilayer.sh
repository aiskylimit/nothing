...
SYNID_STUDENT_LAYERS="${SYNID_STUDENT_LAYERS:-24,25,26}"
SYNID_TEACHER_LAYERS="${SYNID_TEACHER_LAYERS:-32,33,34}"
SYNID_LAYER_CONFIG="${SYNID_LAYER_CONFIG:-k3_last_s24_25_26_t32_33_34}"
