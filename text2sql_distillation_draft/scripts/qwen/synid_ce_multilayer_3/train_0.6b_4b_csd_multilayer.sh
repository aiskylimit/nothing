...
SYNID_STUDENT_LAYERS="${SYNID_STUDENT_LAYERS:-25,26,27}"
SYNID_TEACHER_LAYERS="${SYNID_TEACHER_LAYERS:-33,34,35}"
SYNID_LAYER_CONFIG="${SYNID_LAYER_CONFIG:-k3_last_s25_26_27_t33_34_35}"
