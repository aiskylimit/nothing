...
INFER_OUTPUT_ROOT="${INFER_OUTPUT_ROOT:-results/infer/synid_ce_multilayer_3}"
...
TARGET_KD_GRID_FILTERS=(
  scripts/qwen/synid_ce_multilayer_3/train_g01.sh
  scripts/qwen/synid_ce_multilayer_3/train_g02.sh
  scripts/qwen/synid_ce_multilayer_3/train_g06.sh
  scripts/qwen/synid_ce_multilayer_3/train_g07.sh
)
