...
INFER_OUTPUT_ROOT="${INFER_OUTPUT_ROOT:-results/infer/synid_ce_keywords_weight}"
...
bash running.sh \
  ...
  --skip-finalize \
  --filter scripts/qwen/synid_ce_keywords_weight/train_g \
  --infer-after-train \
  --infer-script scripts/qwen/synid_ce_keywords_weight/infer_multiseed.py \
