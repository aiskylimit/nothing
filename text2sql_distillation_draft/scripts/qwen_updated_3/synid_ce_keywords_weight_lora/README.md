...
SynID-CE CSD alpha/beta sweep on Spider privileged LoRA-1090 augmented data with SQL keyword/schema token up-weighting during semantic-anchor pooling. Alpha and beta use the same value in each grid item.
