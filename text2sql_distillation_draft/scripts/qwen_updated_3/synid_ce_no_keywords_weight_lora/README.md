...
SynID-CE CSD alpha/beta sweep on Spider privileged LoRA-1090 augmented data without SQL keyword/schema token up-weighting during semantic-anchor pooling. Alpha and beta use the same value in each grid item.
...
- `hf://distillation-sql/baselines/qwen3/sft_sft_qwen3_4b_spider_lora/e5-bs4-lr0.0001-G4-N2-NN1-lora-32-64-0.1/1090`
...
```bash
bash scripts/qwen_updated_3/synid_ce_no_keywords_weight_lora/run_full_pipeline.sh
```
