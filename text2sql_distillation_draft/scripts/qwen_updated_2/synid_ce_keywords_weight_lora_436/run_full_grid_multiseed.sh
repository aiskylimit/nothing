...
TARGET_KD_GRID_FILTERS=(
  ...
  scripts/qwen_updated_2/synid_ce_keywords_weight_lora_436/train_g05.sh
  scripts/qwen_updated_2/synid_ce_keywords_weight_lora_436/train_g06.sh
  scripts/qwen_updated_2/synid_ce_keywords_weight_lora_436/train_g07.sh
  scripts/qwen_updated_2/synid_ce_keywords_weight_lora_436/train_g08.sh
)
