...
INFER_OUTPUT_ROOT="${INFER_OUTPUT_ROOT:-results/infer/synid_ce_keywords_weight_lora_218}"
...
TARGET_KD_GRID_FILTERS=(
  ...
  scripts/qwen_updated_2/synid_ce_keywords_weight_lora_218/train_g02.sh
  scripts/qwen_updated_2/synid_ce_keywords_weight_lora_218/train_g03.sh
  scripts/qwen_updated_2/synid_ce_keywords_weight_lora_218/train_g04.sh
  scripts/qwen_updated_2/synid_ce_keywords_weight_lora_218/train_g05.sh
  scripts/qwen_updated_2/synid_ce_keywords_weight_lora_218/train_g06.sh
  scripts/qwen_updated_2/synid_ce_keywords_weight_lora_218/train_g07.sh
  scripts/qwen_updated_2/synid_ce_keywords_weight_lora_218/train_g08.sh
)
