...
TEACHER_LAYER_MAPPING=(33 36)
STUDENT_LAYER_MAPPING=(25 28)
...
SAVE_TAG="${SAVE_TAG:-${SCRIPT_GROUP}_${SCRIPT_NAME}_spider_sfkl_t${TEACHER_LAYERS_TAG}_s${STUDENT_LAYERS_TAG}_${RUN_TAG}}"
