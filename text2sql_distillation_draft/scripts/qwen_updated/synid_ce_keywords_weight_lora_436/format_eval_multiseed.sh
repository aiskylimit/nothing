...
COLLECT_SCRIPT="${COLLECT_SCRIPT:-scripts/qwen_updated/synid_ce_keywords_weight_lora_436/collect_eval_results.py}"
...
usage() {
  cat <<'EOF'
Usage: bash scripts/qwen_updated/synid_ce_keywords_weight_lora_436/format_eval_multiseed.sh [benchmark ...]
