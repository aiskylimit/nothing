...
Environment overrides:
  INFER_OUTPUT_ROOT     Default: results/infer/synid_ce_no_keywords_weight_lora_218/qwen
  EVAL_OUTPUT_ROOT      Default: results/eval/synid_ce_no_keywords_weight_lora_218/qwen
  ETYPE                 Default: all
