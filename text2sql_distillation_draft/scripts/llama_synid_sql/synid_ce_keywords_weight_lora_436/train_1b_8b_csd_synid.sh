...
SYNID_DATASET_NAME="${SYNID_DATASET_NAME:-synid_privileged_lora_436}"
...
TEACHER_PEFT_PATH="${TEACHER_PEFT_PATH:-https://huggingface.co/distillation-sql/llama_spider/tree/main/llama/sft_sft_llama3_8b_lora_spider_lm_e5-bs2-lr0.0001-G8-N2-NN1-lora-16-64-0.1/e5-bs2-lr0.0001-G8-N2-NN1-lora-16-64-0.1/1090}"
