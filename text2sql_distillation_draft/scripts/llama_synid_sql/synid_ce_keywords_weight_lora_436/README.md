...
Llama SynID-SQL training on `synid_privileged_lora_436`.

Defaults:

- `DATA_DIR=processed_data/benchmarks/spider_data/synid_privileged_lora_436/llama`
...
```bash
RUN_GPUS=0 bash scripts/llama_synid_sql/synid_ce_keywords_weight_lora_436/train_g01.sh
RUN_GPUS=0 bash scripts/llama_synid_sql/synid_ce_keywords_weight_lora_436/train_g02.sh
```
