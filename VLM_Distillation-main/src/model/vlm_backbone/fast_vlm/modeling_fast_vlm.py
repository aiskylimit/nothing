...
class FastVlmModel(FastVlmPreTrainedModel):
    ...
    def get_image_features(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        # FastVLM uses a timm vision tower; timm wrappers do not support these
        # generation/text-model flags.
        for key in ("output_attentions", "output_hidden_states", "use_cache", "cache_position"):
            kwargs.pop(key, None)
